...
\begin{tabular*}{\linewidth}{r@{\hspace{\infoTableSpace}}l}
	...
	\textbf{Location for labs}	&  BULLER 315\\
...
\begin{tabular*}{\linewidth}{r@{\hspace{\infoTableSpace}}l}
	...
	\textbf{Office Location}				& 339A University Centre	\\
	\textbf{Office Hours or Availability} & 12:00\,--\,1:00 pm W ({\bf 531 UC}) or by appointment.\\
...
\begin{itemize}
\item K. Atkinson and W. Han, {\em Elementary Numerical Analysis}, third edition, Wiley, 2003, or
\item R. L. Burden and J. D. Faires, {\em Numerical Analysis}, tenth edition, Cengage Learning, 2015, or
\item W. Gaustchi, {\em Numerical Analysis: An Introduction}, second edition, Birkh\"auser, 2012, or
\item E. S\"uli and D. Mayers, {\em An Introduction to Numerical Analysis}, Cambridge University Press, 2003.
\end{itemize}

A copy of {\sc Julia-1.13}, available from \href{https://julialang.org/downloads/}{https://julialang.org/downloads/}.
...
The quizzes will be scheduled for distribution via Crowdmark on Wednesday at 12:00 pm, before the labs and they will be due on Friday evenings at 5:00 pm. The labs themselves on Wednesdays afternoons will give you a chance to interface with the TAs so that they may guide you to successfully solve the weekly quizzes.
...
No missed quizzes will be accepted; however, if a student reports an absence to the instructor within two days of the due date, then this quiz will not be counted toward their quiz average.
...
We will use UM Learn, Crowdmark, {\sc Julia}, and e-mail communication as the primary technologies and transmission of information.
...
\url{https://umanitoba.ca/student-supports/accessibility} \\
...
Quizzes are {\bf open everything}, but students must submit their own written work.
...
The final examination is {\bf closed everything}.
