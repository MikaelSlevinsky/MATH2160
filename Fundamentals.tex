...
The concept of the $p$-norms can be extended to the case of infinite-dimensional vector spaces. An example of such spaces are sequence spaces, and the following spaces describe sequence spaces that have finite norm.
